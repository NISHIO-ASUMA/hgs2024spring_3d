...
{
	g_camera.posV = D3DXVECTOR3(0.0f, 200.0f, -1600.0f);	 // カメラの位置
...
//      プレイヤー追従処理
//****************************************
		g_camera.posRDest.x = GetPlayer()->pos.x + sinf(GetPlayer()->rotDestPlayer.y) * 1.0f;
		g_camera.posRDest.y = GetPlayer()->pos.y + cosf(GetPlayer()->rotDestPlayer.y) * 1.0f;
		g_camera.posRDest.z = GetPlayer()->pos.z + cosf(GetPlayer()->rotDestPlayer.y) * 1.0f;
